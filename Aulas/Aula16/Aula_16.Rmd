...
- Assim, o suavizador de Kalman fornece as estimativas do vetor de estados e da matriz de covariâncias no instante $t-1$, utilizando como informação todas as observações $Z_1, Z_2, \ldots, Z_N$ da série temporal. 
