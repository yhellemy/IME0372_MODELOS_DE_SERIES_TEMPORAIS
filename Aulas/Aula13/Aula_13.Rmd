...
$$BIC(k,l) = \ln{\hat{\sigma}^2_{k,l}} + (k+l)\frac{\ln}{N}.$$
...
- Portanto,  olhando as estimativas de autocorrelações e autocorrelações parciais com $(d=1)$, tem-se que o modelo escolhido é $ARMA(1,1,0).$
